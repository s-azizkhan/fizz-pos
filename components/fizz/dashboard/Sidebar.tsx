...
export default function Sidebar({
  ...
  // Desktop only — mobile navigates via the bottom tab bar (BottomNav).
  return (
    <aside
      className={[
        "fixed inset-y-0 left-0 z-50 hidden flex-col border-r border-ink-line bg-ink-soft/60 backdrop-blur lg:flex",
